...
namespace DoctrineProxies\__CG__\Taxonomy\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Taxonomy extends \Taxonomy\Entity\Taxonomy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'code', 'terms', 'id', 'owner', 'resourceClass', 'resourceTemplate', 'thumbnail', 'title', 'isPublic', 'created', 'modified', 'values'];
        }
    ...
    public function getTerm(string $code)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTerm', [$code]);

        return parent::getTerm($code);
    }

    /**
     * {@inheritDoc}
     */
    public function addTerm(\Taxonomy\Entity\TaxonomyTerm $term)
    {
