 ...
 */
class TaxonomyTerm extends \Taxonomy\Entity\TaxonomyTerm implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxonomyTerm $proxy) {
    ...
    public function getTaxonomy()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTaxonomy', []);
     ...
     * {@inheritDoc}
     */
    public function setTaxonomy(\Taxonomy\Entity\Taxonomy $taxonomy)
    {
